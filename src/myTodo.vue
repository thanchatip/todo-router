<template>
  <div id="app" class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a v-on:click="loadTodo()" class="navbar-brand" href="#">
        <h4> MyTodo </h4>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a v-on:click="loadTodo() , showCreate = false , showTodo = true" class="nav-link" href="#"> Todo List <span
                class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a v-on:click="showTodo = false , showCreate = true, isEmpty = false" class="nav-link" href="#"> Create
    ...
    <div v-if="showCreate">
      ...
      <button type="button" class="btn btn-primary" v-on:click="loadTodo(), showCreate = false , showTodo = true">
        Cancel </button>&nbsp;
      <button v-if="!isEmpty" type="button" class="btn btn-primary"
        v-on:click="showCreate = true , showTodo = false ,emptySave = true"> Save </button>
      <button v-else type="button" class="btn btn-primary"
        v-on:click="saveTodo(), showCreate = false , showTodo = true"> Save </button>
    </div>
    <!--edit page-->
    <div v-if="showEdit">
      <div class="form-group">
      ...
      <button type="button" class="btn btn-primary" v-on:click="loadTodo(), showCreate = false , showTodo = true">
        Cancel </button>&nbsp;
      <button v-if="isEmpty !== true" type="button" class="btn btn-primary"
        v-on:click="updateTodoText(), showEdit = false , showTodo = true"> Save </button>
    </div>
    <!--home page-->
    <div v-if="showTodo">
      <div class="card mb-2" v-for="(todo , index) in todos" v-bind:key="todo.id">
        <div class="card-body">
          ...
          <button v-on:click=" editTodo(todo) , showTodo = false , showEdit = true" class="btn btn-primary"> Edit
          </button>&nbsp;
